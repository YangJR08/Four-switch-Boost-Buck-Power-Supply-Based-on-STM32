...
#define ADC_Iout_Pin GPIO_PIN_1
#define ADC_Iout_GPIO_Port GPIOA
#define ADC_Vout_Pin GPIO_PIN_2
#define ADC_Vout_GPIO_Port GPIOA
#define ADC_VinA3_Pin GPIO_PIN_3
#define ADC_VinA3_GPIO_Port GPIOA
...
#define PWM1_H_Pin GPIO_PIN_12
#define PWM1_H_GPIO_Port GPIOB
#define PWM1_L_Pin GPIO_PIN_13
#define PWM1_L_GPIO_Port GPIOB
#define PWM2_H_Pin GPIO_PIN_14
#define PWM2_H_GPIO_Port GPIOB
